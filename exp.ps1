...
$Files_Selected = New-Object System.Collections.ArrayList
...
#$Files_Selected = [ Additional.html , index.html ]
$Files_Selected = "Additional.html" , "index.html"
git format-patch -1 Head $Files_Selected --stdout > $Patch_name
